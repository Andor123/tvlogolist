...
{
	$name = $_POST["name"];
	$sql = "SELECT id, image, name, genre FROM tvtable WHERE country='Burkina Faso' AND name LIKE '%$name%'";
	$result = mysqli_query($connection, $sql);
}
else 
{
	$sql = "SELECT id, image, name, genre FROM tvtable WHERE country='Burkina Faso'";
	$result = mysqli_query($connection, $sql);
}
?>
<!DOCTYPE html>
...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="col">
				<h1 class="display-4">Burkina Faso</h1>
			</div>
		</div>
		<div class="row">
			<div class="col">
