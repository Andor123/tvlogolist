...
{
	$name = $_POST["name"];
	$sql = "SELECT id, image, name, genre FROM tvtable WHERE country='Libya' AND name LIKE '%$name%'";
	$result = mysqli_query($connection, $sql);
}
else 
{
	$sql = "SELECT id, image, name, genre FROM tvtable WHERE country='Libya'";
	$result = mysqli_query($connection, $sql);
}
?>
<!DOCTYPE html>
