...
{
	$name = $_POST["name"];
	$sql = "SELECT id, image, name, genre FROM tvtable WHERE country='Dominican Republic' AND name LIKE '%$name%'";
	$result = mysqli_query($connection, $sql);
}
else 
{
	$sql = "SELECT id, image, name, genre FROM tvtable WHERE country='Dominican Republic'";
	$result = mysqli_query($connection, $sql);
}
?>
<!DOCTYPE html>
...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="col">
				<h1 class="display-4">Dominican Republic</h1>
			</div>
		</div>
		<div class="row">
			<div class="col">
